...
AddEventHandler('pmavoice:settingsCallback', function(cb)
	cb(Cfg)
end)
...
RegisterCommand('+cycleproximity', function()
	...
	TriggerEvent('pmavoice:setTalkingMode', voiceMode)
end, false)
RegisterCommand('-cycleproximity', function()
end)
RegisterKeyMapping('+cycleproximity', 'Changer la portée de la voix', 'keyboard', GetConvar('voice_defaultCycle', 'F11'))
...
RegisterNetEvent('pmavoice:toggleMute', toggleMute)
...
function setVoiceProperty(type, value)
	...
	elseif type == "micClicks" then
		...
		micClicks = val
		SetResourceKvp('pmavoice_enableMicClicks', val)
	end
end
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	local micClicksKvp = GetResourceKvpString('pmavoice_enableMicClicks')
	if not micClicksKvp then
		SetResourceKvp('pmavoice_enableMicClicks', tostring(true))
	else
