...
RegisterNetEvent('pmavoice:syncRadioData', syncRadioData)
...
RegisterNetEvent('pmavoice:setTalkingOnRadio', setTalkingOnRadio)
...
RegisterNetEvent('pmavoice:addPlayerToRadio', addPlayerToRadio)
...
RegisterNetEvent('pmavoice:removePlayerFromRadio', removePlayerFromRadio)
...
function setRadioChannel(channel)
	...
	TriggerServerEvent('pmavoice:setPlayerRadio', channel)
...
RegisterCommand('+radiotalk', function()
	...
	if not radioPressed and radioEnabled then
		if radioChannel > 0 then
			...
			playerTargets(radioData, NetworkIsPlayerTalking(PlayerId()) and callData or {})
			TriggerServerEvent('pmavoice:setTalkingOnRadio', true)
			radioPressed = true
			playMicClicks(true)
			...
			Citizen.CreateThread(function()
				TriggerEvent("pmavoice:radioActive", true)
...
RegisterCommand('-radiotalk', function()
	if radioChannel > 0 or radioEnabled and radioPressed then
		...
		playerTargets(NetworkIsPlayerTalking(PlayerId()) and callData or {})
		TriggerEvent("pmavoice:radioActive", false)
		playMicClicks(false)
		StopAnimTask(PlayerPedId(), "random@arrests", "generic_radio_enter", -4.0)
		TriggerServerEvent('pmavoice:setTalkingOnRadio', false)
	end
end, false)

RegisterKeyMapping('+radiotalk', 'Parler radio', 'keyboard', GetConvar('voice_defaultRadio', 'LMENU'))
...
RegisterNetEvent('pmavoice:clSetPlayerRadio', syncRadio)
